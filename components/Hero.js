                            ...
                            <div className="sm:text-center lg:text-left">
                                ...
                                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                                    <div className="rounded-md shadow">
                                            ...
                                            <Link href={
                                                loggedInUser ? '/products' : '/login'
                                            }>
                                            <a style={{ background: "#9b7ede" }} className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white hover:bg-indigo-700 md:py-4 md:text-lg md:px-10">
                                                Get started
                                            </a>
                                        </Link>
